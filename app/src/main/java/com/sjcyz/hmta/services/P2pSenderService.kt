...
import com.sjcyz.hmta.models.DeviceInfo
...
import com.sjcyz.hmta.utils.JsonWithUnknownKeys
...
import com.sjcyz.hmta.utils.createGroupSuspend
...
import com.sjcyz.hmta.utils.withTimeoutReason
        ...
        val job = CoroutineScope(Dispatchers.IO + SupervisorJob()).launch {
            ...
            try {
                ...
                wifiLock = wm.createWifiLock(
                    WifiManager.WIFI_MODE_FULL_HIGH_PERF, "HMTA:Send"
                )
                wifiLock?.acquire()
